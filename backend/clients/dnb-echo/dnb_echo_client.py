...
if TYPE_CHECKING:
    from .helloworld.helloworld_request_builder import HelloworldRequestBuilder

class DnbEchoClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new DnbEchoClient and sets the default values.
        ...
        if not self.request_adapter.base_url:
            self.request_adapter.base_url = "https://api.dnb.nl/echo-api"
        self.path_parameters["base_url"] = self.request_adapter.base_url
    
    @property
    def helloworld(self) -> HelloworldRequestBuilder:
        """
        The helloworld property
        """
        from .helloworld.helloworld_request_builder import HelloworldRequestBuilder

        return HelloworldRequestBuilder(self.request_adapter, self.path_parameters)
