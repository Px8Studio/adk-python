...
class HistoricalrecordRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/publicregister/{languageCode-id}/{registerCode}/Registrations/ActArticleNames/historicalrecord
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/publicregister/{languageCode%2Did}/{registerCode}/Registrations/ActArticleNames/historicalrecord", path_parameters)
    
    def by_date(self,date: datetime.datetime) -> WithDateItemRequestBuilder:
        """
        Gets an item from the dnb_public_register_client.api.publicregister.item.item.Registrations.ActArticleNames.historicalrecord.item collection
