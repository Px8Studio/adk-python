...
class OrganizationsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/publicregister/{languageCode-id}/Organizations
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/publicregister/{languageCode%2Did}/Organizations{?page*,pageSize*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[OrganizationsRequestBuilderGetQueryParameters]] = None) -> Optional[OrganizationRelationNumbersView]:
        """
        Gets a list of all organizations of the specified register. Only the relation number of the organization arereturned.
