...
@dataclass
class ChildOrganizationView(Parsable):
    """
    The child organization of a parent organization
    """
    ...
    # The date of the declared bankrupty
    date_of_liquidation: Optional[datetime.datetime] = None
    # Whether or not the organization has an APF relation
    is_apf: Optional[bool] = None
    # The isFrom property
    is_from: Optional[bool] = None
    # Whether or not the organization has declared bankruptcy
    is_in_liquidation: Optional[bool] = None
    # If true the organization is a parent organization. Otherwise it's a child organization
    is_main: Optional[bool] = None
    # The legal duration type of the organization
    legal_duration: Optional[str] = None
    # The leicode of the organization
    ...
    # The statutory country of where the organization is located
    ...
    # The statutory place of where the organization is located
    statutory_place: Optional[str] = None
    # The trade names of the organization
    trade_names: Optional[list[TradeNameView]] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> ChildOrganizationView:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: ChildOrganizationView
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return ChildOrganizationView()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "isApf": lambda n : setattr(self, 'is_apf', n.get_bool_value()),
            "isFrom": lambda n : setattr(self, 'is_from', n.get_bool_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_bool_value("isApf", self.is_apf)
        writer.write_bool_value("isFrom", self.is_from)
