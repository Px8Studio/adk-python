...
@dataclass
class RegisterArticleView(Parsable):
    """
    The configured act articles
    """
    # The code of the act article
    act_article_code: Optional[str] = None
    # The name of the act article
    act_article_name: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> RegisterArticleView:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: RegisterArticleView
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return RegisterArticleView()
