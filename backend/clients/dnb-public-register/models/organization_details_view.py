...
@dataclass
class OrganizationDetailsView(Parsable):
    """
    The organization details of a specific register
    """
    # The organizations which belong to the register
    organizations: Optional[list[OrganizationView]] = None
    # When the register has been last published
    publish_date: Optional[datetime.datetime] = None
    # The code of the register the organizations belongs to
    register_code: Optional[str] = None
    # The name of the register
    register_name: Optional[str] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> OrganizationDetailsView:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: OrganizationDetailsView
        """
