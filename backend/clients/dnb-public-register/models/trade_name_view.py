...
@dataclass
class TradeNameView(Parsable):
    """
    The trade name details
    """
    # The trade name
    name: Optional[str] = None
    # The end date of the trade name
    validity_period_end_date: Optional[datetime.datetime] = None
    # The start date of the trade name
    validity_period_start_date: Optional[datetime.datetime] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> TradeNameView:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: TradeNameView
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return TradeNameView()
