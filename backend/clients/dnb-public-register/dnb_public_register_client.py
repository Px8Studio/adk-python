...
class DnbPublicRegisterClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new DnbPublicRegisterClient and sets the default values.
        ...
        if not self.request_adapter.base_url:
            self.request_adapter.base_url = "https://api.dnb.nl/publicdata/v1"
