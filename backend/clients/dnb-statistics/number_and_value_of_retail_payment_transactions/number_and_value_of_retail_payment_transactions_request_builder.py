...
if TYPE_CHECKING:
    from .number_and_value_of_retail_payment_transactions_get_response import NumberAndValueOfRetailPaymentTransactionsGetResponse

class NumberAndValueOfRetailPaymentTransactionsRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /number-and-value-of-retail-payment-transactions
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new NumberAndValueOfRetailPaymentTransactionsRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/number-and-value-of-retail-payment-transactions{?page*,pageSize*,sort*,sortDirection*}", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[NumberAndValueOfRetailPaymentTransactionsRequestBuilderGetQueryParameters]] = None) -> Optional[NumberAndValueOfRetailPaymentTransactionsGetResponse]:
        """
        ...
        Returns: Optional[NumberAndValueOfRetailPaymentTransactionsGetResponse]
        """
        ...
        return await self.request_adapter.send_async(request_info, NumberAndValueOfRetailPaymentTransactionsGetResponse, None)
    
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[NumberAndValueOfRetailPaymentTransactionsRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        <p>Retail payments, quarterly figures from 2022. Both domestic and cross-border payments.&#160;<p>Data regarding the period&#160;March 2005 until December 2021 is available in table 5.12S (periodicity:&#160;<a href="https://www.dnb.nl/en/statistics/data-search/#/details/retail-payments-quarter-discontinued/dataset/9aa3c704-8e00-40b2-b075-b17e2a63de30" target="_blank">quarterly</a>&#160;and&#160;<a href="https://www.dnb.nl/en/statistics/data-search/#/details/retail-payments-year-discontinued/dataset/2c16d665-f7a1-4491-96d5-80e04bd506d3" target="_blank">yearly</a>).&#160;From 2022 onwards the data are subject to a new reporting scheme.</p><p>Data on a half-yearly basis is available in the&#160;<a href="https://www.dnb.nl/en/statistics/data-search/#/details/payment-statistics-half-year/dataset/85e5e0a4-7bf7-472b-b4d8-5ea1725034a2" target="_blank">table Payment statistics (Half-Year)</a>. This data is published at a lower frequency but contains more detail compared to the quarterly version.</p></p><p><b>Table Number: </b>5.12</p><p><b>Unit: </b>Number (in thousands), EUR millions</p><p><b>Source: </b>DNB</p>
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> NumberAndValueOfRetailPaymentTransactionsRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: NumberAndValueOfRetailPaymentTransactionsRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return NumberAndValueOfRetailPaymentTransactionsRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class NumberAndValueOfRetailPaymentTransactionsRequestBuilderGetQueryParameters():
        """
        <p>Retail payments, quarterly figures from 2022. Both domestic and cross-border payments.&#160;<p>Data regarding the period&#160;March 2005 until December 2021 is available in table 5.12S (periodicity:&#160;<a href="https://www.dnb.nl/en/statistics/data-search/#/details/retail-payments-quarter-discontinued/dataset/9aa3c704-8e00-40b2-b075-b17e2a63de30" target="_blank">quarterly</a>&#160;and&#160;<a href="https://www.dnb.nl/en/statistics/data-search/#/details/retail-payments-year-discontinued/dataset/2c16d665-f7a1-4491-96d5-80e04bd506d3" target="_blank">yearly</a>).&#160;From 2022 onwards the data are subject to a new reporting scheme.</p><p>Data on a half-yearly basis is available in the&#160;<a href="https://www.dnb.nl/en/statistics/data-search/#/details/payment-statistics-half-year/dataset/85e5e0a4-7bf7-472b-b4d8-5ea1725034a2" target="_blank">table Payment statistics (Half-Year)</a>. This data is published at a lower frequency but contains more detail compared to the quarterly version.</p></p><p><b>Table Number: </b>5.12</p><p><b>Unit: </b>Number (in thousands), EUR millions</p><p><b>Source: </b>DNB</p>
        """
    ...
    @dataclass
    class NumberAndValueOfRetailPaymentTransactionsRequestBuilderGetRequestConfiguration(RequestConfiguration[NumberAndValueOfRetailPaymentTransactionsRequestBuilderGetQueryParameters]):
        """
