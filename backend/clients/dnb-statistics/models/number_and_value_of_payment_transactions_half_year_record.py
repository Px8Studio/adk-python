...
@dataclass
class NumberAndValueOfPaymentTransactionsHalfYearRecord(AdditionalDataHolder, Parsable):
    # Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
    additional_data: dict[str, Any] = field(default_factory=dict)

    # The name of the geographical region of the counterparty
    geography_counterparty: Optional[str] = None
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> NumberAndValueOfPaymentTransactionsHalfYearRecord:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: NumberAndValueOfPaymentTransactionsHalfYearRecord
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return NumberAndValueOfPaymentTransactionsHalfYearRecord()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            "geographyCounterparty": lambda n : setattr(self, 'geography_counterparty', n.get_str_value()),
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("geographyCounterparty", self.geography_counterparty)
