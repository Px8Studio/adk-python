...
@dataclass
class SummaryBalanceSheetOfPensionFundsByTypeQuarterRecord(AdditionalDataHolder, Parsable):
    ...
    # The type of pension fund
    type: Optional[str] = None
    # The value of the observation
    value: Optional[float] = None
    
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SummaryBalanceSheetOfPensionFundsByTypeQuarterRecord:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: SummaryBalanceSheetOfPensionFundsByTypeQuarterRecord
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return SummaryBalanceSheetOfPensionFundsByTypeQuarterRecord()
