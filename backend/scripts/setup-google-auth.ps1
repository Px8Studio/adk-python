...
function Write-Error { param($msg) Write-Host "âŒ $msg" -ForegroundColor Red }
function Write-Step { param($msg) Write-Host "`nðŸ”¹ $msg" -ForegroundColor Blue }
...
Write-Host "â•‘  Google Cloud Authentication Setup for Orkhon                 â•‘" -ForegroundColor Magenta
...
Write-Info "Python verification skipped - you can manually test authentication"
